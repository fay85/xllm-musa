...
// MUSA activation implementation.  The gated SiLU path uses the native
// swish_glu operator; the generic common activation route remains device
// agnostic and is not changed by this backend specialization.
