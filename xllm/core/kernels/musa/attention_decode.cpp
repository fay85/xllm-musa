...
constexpr int32_t kFa3MaxMetadataWarps = 17;
constexpr int32_t kFa3MaxMetadataBatchSize = 512;
...
// Dense ragged FA3 prefill artifacts generated by Mate 0.2.5.
...
int32_t fa3_metadata_num_warps(int32_t batch_size) {
  ...
  CHECK_LE(batch_size, kFa3MaxMetadataBatchSize)
      << "MUSA FA3 metadata supports batch sizes up to "
      << kFa3MaxMetadataBatchSize;
